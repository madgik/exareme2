...
celery = Celery(
    ...
    backend="rpc://",
    include=[
        "exareme2.node.tasks.tables",
        "exareme2.node.tasks.remote_tables",
        "exareme2.node.tasks.merge_tables",
        "exareme2.node.tasks.views",
        "exareme2.node.tasks.common",
        "exareme2.node.tasks.udfs",
        "exareme2.node.tasks.smpc",
    ],
)

...
from exareme2.controller import node_landscape_aggregator
...
async def get_datasets_locations() -> dict:
    return node_landscape_aggregator.get_datasets_locations().datasets_locations


@algorithms.route("/cdes_metadata", methods=["GET"])
async def get_cdes_metadata() -> dict:
    return node_landscape_aggregator.get_cdes_per_data_model()


@algorithms.route("/data_models_attributes", methods=["GET"])
async def get_data_models_attributes() -> dict:
    return node_landscape_aggregator.get_data_models_attributes()

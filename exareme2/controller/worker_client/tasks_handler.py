...
from exareme2.controller.worker_client.app import WorkerClientFactory
...
class WorkerTasksHandler:
    ...
    def load_data_folder(
        self, request_id: str, timeout: int, folder: Optional[str] = None
    ) -> str:
        response = self._client().call(
            "LoadDataFolder",
            worker_pb2.LoadDataFolderRequest(
                request_id=request_id,
                folder=(
                    wrappers_pb2.StringValue(value=folder)

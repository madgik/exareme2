...
def create_pool(minsize=5, maxsize=64, echo=False, pool_recycle=-1,
                loop=None, **kwargs):
...
async def _create_pool(minsize=5, maxsize=64, echo=False, pool_recycle=-1,
                       loop=None, **kwargs):
    if loop is None:

...
def make_input_data_variables(props):
    if props["stattypes"] == ["numerical"]:
        return NumericalInputDataVariables(props["notblank"], props["multiple"])
    elif props["stattypes"] == ["nominal"]:
        raise NotImplementedError
    elif set(props["stattypes"]) == {"numerical", "nominal"}:
        raise NotImplementedError


def make_parameters(props):
    raise NotImplementedError
...
class InputGenerator:
    def __init__(self, specs_file):
        ...
        self.parameter_gens = {
            name: make_parameters(properties)

...
from mipengine.algorithms.descriptive_statistics import Result
from mipengine.algorithms.descriptive_statistics import Variable
from mipengine.algorithms.descriptive_statistics import reduce_recs_for_var
...
if __name__ == "__main__":
    ...
    with open("descriptive_statistics_expected.json", "w") as expected_file:

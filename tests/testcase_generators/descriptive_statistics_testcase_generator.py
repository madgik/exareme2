...
class DesciptiveStatisticsTestCaseGenerator(TestCaseGenerator):
    def compute_expected_output(
        ...
        numerical_columns_dataset = sorted(
            list(set(all_columns_dataset).intersection(set(numerical_columns)))
        )
        categorical_columns_dataset = sorted(
            list(set(all_columns_dataset).intersection(set(categorical_columns)))
        )

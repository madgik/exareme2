...
from exaflow.algorithms.exareme3.logistic_regression import LogisticRegressionSummary
...
if __name__ == "__main__":
    with open("exareme3/algorithms/logistic_regression.json") as specs_file:

...
# from tests import get_node_db_connection
...
# local_node_get_run_udf_query = (
#     nodes_communication.get_celery_get_run_udf_query_signature(local_node)
# )
...
#     positional_args = [
#         UDFArgument(type="table", value=table_1_name).to_json(),
#         UDFArgument(type="literal", value="15").to_json(),
#     ]

#     udf_table_name = local_node_run_udf.delay(
...
#     udf_creation_statement, execution_statement = local_node_get_run_udf_query.delay(
#         command_id=command_id,
#         context_id=context_id,
#         func_name="demo.table_and_literal_arguments",
#         positional_args_json=positional_args,
...
#     assert execution_statement == proper_execution_statement.substitute(
...
# proper_execution_statement = Template(
#     """DROP TABLE IF EXISTS table_command123_udfs_test_localnode1;

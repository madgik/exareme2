...
# del os.environ["MIPENGINE_CONTROLLER_CONFIG_FILE"]
# ############
...
@pytest.fixture(scope="function")
def load_data_tmplocalnode(monetdb_tmp_localnode):
    _init_database_monetdb_container(COMMON_IP, MONETDB_TMP_LOCALNODE_PORT)
    _load_data_monetdb_container(COMMON_IP, MONETDB_TMP_LOCALNODE_PORT)
    yield

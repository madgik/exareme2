...
LANGUAGE PYTHON
{
    import pandas as pd
    import udfio
    r = pd.DataFrame({name: _columns[name_w_prefix] for name, name_w_prefix in zip(['row_id', 'col0', 'col1', 'col2'], ['r_row_id', 'r_col0', 'r_col1', 'r_col2'])}).set_index('row_id')
    result = r
    return udfio.as_tensor_table(numpy.array(result))
}"""
...
LANGUAGE PYTHON
{
    import pandas as pd
    import udfio
    r1 = pd.DataFrame({name: _columns[name_w_prefix] for name, name_w_prefix in zip(['row_id', 'col0', 'col1', 'col2'], ['r1_row_id', 'r1_col0', 'r1_col1', 'r1_col2'])}).set_index('row_id')
    r2 = pd.DataFrame({name: _columns[name_w_prefix] for name, name_w_prefix in zip(['row_id', 'col4', 'col5', 'col6'], ['r2_row_id', 'r2_col4', 'r2_col5', 'r2_col6'])}).set_index('row_id')
    result = r1
    return udfio.as_tensor_table(numpy.array(result))
}"""
...
LANGUAGE PYTHON
{
    ...
    r1 = pd.DataFrame({name: _columns[name_w_prefix] for name, name_w_prefix in zip(['row_id', 'col0', 'col1', 'col2'], ['r1_row_id', 'r1_col0', 'r1_col1', 'r1_col2'])}).set_index('row_id')
    r2 = pd.DataFrame({name: _columns[name_w_prefix] for name, name_w_prefix in zip(['row_id', 'col4', 'col5', 'col6'], ['r2_row_id', 'r2_col4', 'r2_col5', 'r2_col6'])}).set_index('row_id')
    r3 = pd.DataFrame({name: _columns[name_w_prefix] for name, name_w_prefix in zip(['row_id', 'col8', 'col9', 'col10'], ['r3_row_id', 'r3_col8', 'r3_col9', 'r3_col10'])}).set_index('row_id')
    result = r1
    return udfio.as_tensor_table(numpy.array(result))
}"""
...
LANGUAGE PYTHON
{
    ...
    import udfio
    r1 = pd.DataFrame({name: _columns[name_w_prefix] for name, name_w_prefix in zip(['row_id', 'col0', 'col1', 'col2'], ['r1_row_id', 'r1_col0', 'r1_col1', 'r1_col2'])}).set_index('row_id')
    r2 = pd.DataFrame({name: _columns[name_w_prefix] for name, name_w_prefix in zip(['row_id', 'col0', 'col1', 'col2'], ['r2_row_id', 'r2_col0', 'r2_col1', 'r2_col2'])}).set_index('row_id')
    result = r1
    return udfio.as_tensor_table(numpy.array(result))
}"""
...
LANGUAGE PYTHON
{
    import pandas as pd
    import udfio
    r = pd.DataFrame({name: _columns[name_w_prefix] for name, name_w_prefix in zip(['row_id', 'c0', 'c1', 'c2'], ['r_row_id', 'r_c0', 'r_c1', 'r_c2'])}).set_index('row_id')
    result = r
    return udfio.as_tensor_table(numpy.array(result))
}"""

...
from mipengine.node_exceptions import DataModelUnavailable, DatasetUnavailable, InsufficientDataError
...
def test_data_model_view_with_data_model_unavailable_exception(request_id, context_id):
    ...
    assert "Data model 'non_existing' is not available in node: 'localnode1'" in exc.value.message
...
def test_data_model_view_with_dataset_unavailable_exception(request_id, context_id):
    ...
    assert "Dataset 'non_existing' is not available in node: 'localnode1'" in exc.value.message

# import pytest
# from mipengine.node_info_DTOs import (
#     NodeRegistryClient,
#     NodeRole,
#     Pathology,
#     Pathologies,
...
#     pytest.assume(node_registry_client.schema_exists("pathology1"))
#     pytest.assume(not node_registry_client.schema_exists("non_existing_pathology"))
#
#

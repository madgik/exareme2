...
class DataModelRegistry(BaseModel):
    ...
    dataset_location: Dict[str, Dict[str, str]]
    ...
    def get_all_available_datasets_per_data_model(self) -> Dict[str, List[str]]:
        ...
        """
        return {
            data_model: list(self.dataset_location[data_model].keys())
            for data_model in self.data_models
        }

    def data_model_exists(self, data_model: str) -> bool:
        return data_model in self.dataset_location

    def dataset_exists(self, data_model: str, dataset: str) -> bool:
        return (
            data_model in self.dataset_location
            and dataset in self.dataset_location[data_model]
        )
    ...
    def get_node_ids_with_any_of_datasets(
        ...
        local_nodes_with_datasets = [
            self.dataset_location[data_model][dataset]
            for dataset in self.dataset_location[data_model]
    ...
    def get_node_specific_datasets(
        ...
        datasets_in_node = [
            ...
            and node_id == self.dataset_location[data_model][dataset]
        ]

...
#from .ListOfNpArrays import ListNpOfArrays

def generate_initial_centroids(num_of_dimensions:int, num_of_clusters:int, min_val:float, max_val:float) -> numpy.ndarray:
    initial_centroids=np.random.uniform(min_val,max_val, size=(num_of_clusters, num_of_dimensions))
...
def _local(centroids:numpy.ndarray,data_points:numpy.ndarray)->numpy.ndarray:
    ...
    returns:
        a numpy array of shape Cx3, where C the number of clusters. The 2 columns correspond

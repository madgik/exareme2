...
PyAPI_FUNC(int) PyFloat_Check(void * arg0);
#define PyFloat_CheckExact PyPyFloat_CheckExact
PyAPI_FUNC(int) PyFloat_CheckExact(void * arg0);
...
#define PyGC_Disable PyPyGC_Disable
PyAPI_FUNC(int) PyGC_Disable(void);
#define PyGC_Enable PyPyGC_Enable
PyAPI_FUNC(int) PyGC_Enable(void);
#define PyGC_IsEnabled PyPyGC_IsEnabled
...
#define PyIter_Send PyPyIter_Send
...
#define PyObject_GC_IsFinalized PyPyObject_GC_IsFinalized
PyAPI_FUNC(int) PyObject_GC_IsFinalized(struct _object *arg0);
#define PyObject_GC_IsTracked PyPyObject_GC_IsTracked
...
#define PyExc_EncodingWarning PyPyExc_EncodingWarning

...
def create_configs(c):
    ...
    aggregation_server_config["host"] = deployment_config["ip"]
    aggregation_server_config["port"] = deployment_config["aggregation_server"]["port"]
    aggregation_server_config["max_workers"] = deployment_config["aggregation_server"][
        "max_workers"
    ]
    aggregation_server_config["timeout"] = deployment_config["aggregation_server"][
        "timeout"
    ]
